...
describe('Features Cards Component', () => {
    const featuresKeywords: Feature[] = [{ sid: { id: 1 }, displayName: `test display name`, epKeywords: ['keywords'], categorySid: { id: 1 } }];
    const featuresNoKeywords: Feature[] = [{ sid: { id: 2 }, displayName: `test display name`, epKeywords: [], categorySid: { id: 1 } }];
